{{--
    Relay override of devdojo/billing's checkout view.

    The packaged view depends on Filament Blade components (<x-filament::modal>),
    which Relay does not install. Relay ships its own pricing experience at
...
<div class="mx-auto max-w-md px-6 py-24 text-center">
    ...
    <p class="mt-2 text-muted">Manage your Relay subscription from the pricing page.</p>
