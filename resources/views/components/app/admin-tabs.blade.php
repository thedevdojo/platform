@php
    $tabs = [
        ['route' => 'admin.index', 'label' => 'Overview', 'icon' => 'dashboard'],
        ['route' => 'admin.products', 'label' => 'Products', 'icon' => 'rocket-launch'],
        ['route' => 'admin.topics', 'label' => 'Topics', 'icon' => 'tag'],
...
<nav class="inline-flex flex-wrap items-center gap-1 rounded-lg border border-line bg-canvas-subtle p-1">
    @foreach ($tabs as $tab)
