...
@php
    ...
    $icons = [
        ...
        'book-open' => '<path d="M12 6.5C10.5 5 8.5 4.2 5.5 4.2c-1 0-1.9.1-2.5.3v14c.6-.2 1.5-.3 2.5-.3 3 0 5 .8 6.5 2.3 1.5-1.5 3.5-2.3 6.5-2.3 1 0 1.9.1 2.5.3v-14c-.6-.2-1.5-.3-2.5-.3-3 0-5 .8-6.5 2.3Z"/><path d="M12 6.5v14"/>',
        ...
        'user-plus' => '<circle cx="10" cy="8" r="4"/><path d="M3 20a7 7 0 0 1 14 0"/><path d="M19 8v6M16 11h6"/>',
        ...
        'building' => '<rect x="4" y="3" width="16" height="18" rx="2"/><path d="M4 21h16M9 7h.01M15 7h.01M9 11h.01M15 11h.01M9 15h.01M15 15h.01"/>',
        'clock' => '<circle cx="12" cy="12" r="9"/><path d="M12 7.5V12l3 2"/>',
        'timer' => '<circle cx="12" cy="13" r="8"/><path d="M12 9.5V13l2.5 1.5M9 2.5h6"/>',
        'message' => '<path d="M21 11.5a8.5 8.5 0 0 1-12.3 7.6L3 21l1.9-5.7A8.5 8.5 0 1 1 21 11.5Z"/>',
        'chat-bubble' => '<path d="M21 11.5a8.5 8.5 0 0 1-12.3 7.6L3 21l1.9-5.7A8.5 8.5 0 1 1 21 11.5Z"/><path d="M8.5 10.5h7M8.5 13.5h4"/>',
        'phone' => '<path d="M5 4h4l1.5 4.5-2.2 1.6a13 13 0 0 0 5.6 5.6l1.6-2.2L20 15v4a2 2 0 0 1-2.2 2A17 17 0 0 1 3 6.2 2 2 0 0 1 5 4Z"/>',
        'life-buoy' => '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="3.5"/><path d="m5.7 5.7 3.8 3.8M14.5 14.5l3.8 3.8M18.3 5.7l-3.8 3.8M9.5 14.5l-3.8 3.8"/>',
        ...
        'star-filled' => '<path d="m12 3 2.6 5.3 5.9.9-4.3 4.1 1 5.8L12 16.9 6.8 19.6l1-5.8-4.3-4.1 5.9-.9L12 3Z" fill="currentColor" stroke="none"/>',
        ...
        'wrench' => '<path d="M14.5 6.5a4.5 4.5 0 0 0-6 5.9L3 18a2 2 0 0 0 3 3l5.6-5.5a4.5 4.5 0 0 0 5.9-6L14 13l-3-3 3.5-3.5Z"/>',
        'chart' => '<path d="M4 4v15a1 1 0 0 0 1 1h15"/><path d="M8 16v-5M12.5 16V7M17 16v-8"/>',
        'smile' => '<circle cx="12" cy="12" r="9"/><path d="M8.5 14.5a4.5 4.5 0 0 0 7 0M9 9.5h.01M15 9.5h.01"/>',
        'reply' => '<path d="m9 10-5 4 5 4"/><path d="M4 14h10a6 6 0 0 0 6-6V6"/>',
        'note' => '<path d="M4 5.5A1.5 1.5 0 0 1 5.5 4h13A1.5 1.5 0 0 1 20 5.5v9L14.5 20h-9A1.5 1.5 0 0 1 4 18.5v-13Z"/><path d="M14 20v-4.5a1 1 0 0 1 1-1H20"/>',
        'paperclip' => '<path d="m20 11.5-7.8 7.8a5 5 0 0 1-7-7L13 4.5a3.3 3.3 0 0 1 4.7 4.7L10 17a1.7 1.7 0 0 1-2.4-2.4l7-7"/>',
        'hash' => '<path d="M9 3 7 21M17 3l-2 18M4 8.5h17M3 15.5h17"/>',

        // ---- Ticket status glyphs ----
        'status-open' => '<circle cx="12" cy="12" r="8" stroke-width="2"/>',
        'status-pending' => '<circle cx="12" cy="12" r="8" stroke-width="2"/><path d="M12 8.5V12l2.5 1.8" stroke-width="2"/>',
        'status-snoozed' => '<circle cx="12" cy="12" r="8" stroke-width="2"/><path d="M9.5 9.5h5l-5 5h5" stroke-width="1.8"/>',
        'status-resolved' => '<circle cx="12" cy="12" r="9" fill="currentColor" stroke="none"/><path d="m8.5 12 2.3 2.3L16 9" stroke="var(--canvas)" stroke-width="2"/>',
        'status-closed' => '<circle cx="12" cy="12" r="8" stroke-width="2" stroke-dasharray="2.6 2.8"/><path d="m9.3 9.3 5.4 5.4M14.7 9.3l-5.4 5.4" stroke-width="1.8"/>',
        ...
        'priority-normal' => '<rect x="4" y="13" width="3.5" height="7" rx="1" fill="currentColor" stroke="none"/><rect x="10.25" y="9" width="3.5" height="11" rx="1" fill="currentColor" stroke="none"/><rect x="16.5" y="5" width="3.5" height="15" rx="1" fill="currentColor" stroke="none" opacity="0.3"/>',
