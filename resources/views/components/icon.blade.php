...
@php
    ...
    $icons = [
        ...
        'chevron-up-bold' => '<path d="m5.5 15 6.5-6.5L18.5 15" stroke-width="2.4"/>',
        'chevron-down' => '<path d="m6 9 6 6 6-6"/>',
        'flame' => '<path d="M12 3s1 2.4 1 4.2c0 1.7-1.3 3-3 3s-3-1.3-3-3c0 0-1.5 2-1.5 5A6.5 6.5 0 0 0 12 21a6.5 6.5 0 0 0 6.5-6.5C18.5 8 12 3 12 3Z"/>',
        'trophy' => '<path d="M8 4h8v6a4 4 0 0 1-8 0V4Z"/><path d="M8 5H5a1 1 0 0 0-1 1v1a3 3 0 0 0 3 3M16 5h3a1 1 0 0 1 1 1v1a3 3 0 0 1-3 3"/><path d="M12 14v3M8.5 20.5h7M12 17c-1.5 0-2.5 1.2-2.5 3.5h5c0-2.3-1-3.5-2.5-3.5Z"/>',
        'gift' => '<rect x="3.5" y="8" width="17" height="4" rx="1"/><path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-7M12 8v13"/><path d="M12 8s-4.5.3-5.5-1.5C5.8 5.2 7 3.5 8.6 3.8 10.6 4.2 12 8 12 8ZM12 8s4.5.3 5.5-1.5c.7-1.3-.5-3-2.1-2.7C13.4 4.2 12 8 12 8Z"/>',
        'crown' => '<path d="M3.5 17.5 3 7l5 4 4-6.5L16 11l5-4-.5 10.5a1.5 1.5 0 0 1-1.5 1.5H5a1.5 1.5 0 0 1-1.5-1.5Z"/>',
        'image' => '<rect x="3" y="4.5" width="18" height="15" rx="2.5"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m4 17 4.8-4.8a1.5 1.5 0 0 1 2.1 0l5.6 5.3M14 14.5l2-2a1.5 1.5 0 0 1 2.1 0L21 15.5"/>',
