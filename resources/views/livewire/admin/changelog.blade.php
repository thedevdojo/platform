...
<div class="mt-7">
    ...
    @else
        <div class="mt-6 flex flex-col items-center justify-center rounded-2xl border border-dashed border-line py-16 text-center">
            ...
            <p class="mt-1.5 max-w-sm text-[14px] text-muted text-pretty">Keep your hunters in the loop by announcing what's new.</p>
        ...
        <div x-show="$wire.showForm"
            ...
            <form wire:submit="save" class="mt-4 space-y-4">
                <div>
                    ...
                    <input wire:model="title" type="text" class="input" placeholder="Introducing launch scheduling" autofocus />
