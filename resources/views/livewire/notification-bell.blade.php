        ...
        <div class="max-h-[60vh] overflow-y-auto">
            ...
            @empty
                <div class="px-4 py-12 text-center">
                    ...
                    <p class="mt-0.5 text-[12px] text-subtle">Ticket assignments and replies will show up here.</p>
                </div>
            @endforelse
        </div>

        <a href="{{ route('notifications') }}" wire:navigate @click="open = false" class="block border-t border-line px-4 py-2.5 text-center text-[12.5px] font-medium text-muted transition-colors hover:bg-elevated hover:text-fg">
