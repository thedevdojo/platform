        ...
        <div class="max-h-[60vh] overflow-y-auto">
            @forelse ($this->items as $note)
                @php
                    ...
                    $meta = match ($event) {
                        'product_voted' => ['icon' => 'chevron-up-bold', 'tone' => 'text-accent bg-accent-soft'],
                        'new_comment' => ['icon' => 'message', 'tone' => 'text-sky-500 bg-sky-500/12'],
                        'product_live' => ['icon' => 'rocket-launch', 'tone' => 'text-emerald-500 bg-emerald-500/12'],
            ...
            @empty
                <div class="px-4 py-12 text-center">
                    ...
                    <p class="mt-0.5 text-[12px] text-subtle">Upvotes and comments on your launches will show up here.</p>
                </div>
            @endforelse
        </div>
    </div>
