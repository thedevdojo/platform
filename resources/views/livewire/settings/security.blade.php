    ...
    <div class="grid gap-6 border-t border-line pt-8 sm:grid-cols-[200px_1fr]">
        ...
        <div class="card p-5">
            <div class="flex items-start gap-4">
                <span class="grid size-10 shrink-0 place-items-center rounded-xl {{ $twoFactorConfirmed ? 'bg-emerald-500/12 text-emerald-500' : 'bg-accent-soft text-accent' }}">
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-2">
                        ...
                        @if ($twoFactorConfirmed)
                            <span class="badge border-emerald-500/30 bg-emerald-500/10 text-emerald-500"><x-icon name="check" class="size-3" /> Enabled</span>
                        @else
