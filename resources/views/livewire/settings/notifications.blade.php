...
new class extends Component
{
    ...
    public function options(): array
    {
        return [
            ...
            'product_updates' => ['label' => 'Product updates', 'description' => 'New features and improvements shipping to Relay.'],
            'marketing_emails' => ['label' => 'Marketing emails', 'description' => 'Occasional tips, offers and announcements.'],
            'blog_notifications' => ['label' => 'Blog & resources', 'description' => 'New posts from the Relay blog.'],
