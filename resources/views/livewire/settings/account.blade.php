...
<form wire:submit="save" class="space-y-8">
    <div class="grid gap-6 sm:grid-cols-[200px_1fr]">
        <div>
            ...
            <p class="mt-1 text-[13px] text-muted text-pretty">This is how you appear across Hunted — on launches you hunt, votes, and your public profile.</p>
        </div>
        <div class="card space-y-5 p-5">
            ...
            <div>
                ...
                <input wire:model="title" type="text" class="input" placeholder="Maker · Indie hacker" />
            </div>
