...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ __('Choose a template') }} - {{ config('app.name', 'Laravel') }}</title>
    ...
    <body class="antialiased">
        @php
            $steps = ['Starter', 'Packages', 'Project', 'Database', 'Review', 'Launch'];
                ...
                <nav class="mt-12 hidden">
                    <ol class="relative space-y-1.5">
                        ...
                        @foreach ($steps as $index => $step)
                            <li class="relative flex items-center gap-3.5 py-1.5">
                                @if ($index === 0)
                    ...
                    <div class="mx-auto max-w-5xl">
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-5 xl:grid-cols-2">
                            @foreach ($templates as $template)
                                <label class="group relative flex cursor-pointer gap-5 rounded-xl border border-zinc-200 bg-white p-3 transition-colors hover:border-zinc-300 has-[:checked]:border-zinc-900 has-[:checked]:ring-1 has-[:checked]:ring-zinc-900">
